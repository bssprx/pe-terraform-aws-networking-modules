...
# -------------------------------
module "nat_gateway" {
  source      = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/nat_gateway?ref=v0.5.0"
...
module "internet_gateway" {
  source      = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/internet_gateway?ref=v0.5.0"
  vpc_id      = module.vpc.vpc_id
  name_prefix = var.name_prefix
  tags        = local.common_tags
...
module "route_table_public" {
  source                  = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/route_table_public?ref=v0.5.0"
  vpc_id                  = module.vpc.vpc_id
  name_prefix             = var.name_prefix
...
module "route_table_private" {
  source                   = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/route_table_private?ref=v0.5.0"
  vpc_id                   = module.vpc.vpc_id
  name_prefix              = var.name_prefix
...
module "transit_gateway_attachment" {
  source = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/transit_gateway_attachment?ref=v0.5.0"
...
module "cloudwatch_log_group_network" {
  source            = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/cloudwatch_log_group?ref=v0.5.0"
...
module "flow_logs_role" {
  source      = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/iam_role?ref=v0.5.0"
...
module "flow_logs_policy" {
  source      = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/iam_policy?ref=v0.5.0"
...
module "cloudwatch_notifications" {
  source      = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/cloudwatch_notifications?ref=v0.5.0"
  count       = var.enable_cloudwatch_alarms ? 1 : 0
  name_prefix = var.name_prefix
  tags        = local.common_tags
...
# -------------------------------
module "vpc_flow_log" {
  source        = "git::https://github.com/bssprx/pe-terraform-aws-networking-modules.git//modules/flow_log?ref=v0.5.0"
  vpc_id        = module.vpc.vpc_id
